...
var authUseCasesModule = Module()
  ...
  ..single<SignInWithEmailAndPasswordUseCase>((scope) => SignInWithEmailAndPasswordUseCase(scope.get<AuthRepository>()))
  ..single<SignInWithGoogleUseCase>((scope) => SignInWithGoogleUseCase(scope.get<AuthRepository>()));

var authBlocsModules = Module()
  ..single<AuthBloc>((scope) => AuthBloc(scope.get(), scope.get(), scope.get(), scope.get()));
